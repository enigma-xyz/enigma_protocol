...
export const vaults: Vault[] = [
  ...
  },
  {
    ...
    intro:
      "Play with our custom made Bollinger Bands and Exponential Moving Average (EMA) Indicator strategies to boost your earnings",
  ...
  },
  {
    ...
    strategy:
      "Supercharger vault employs a delta-neutral market making and liquidity provision strategy, primarily on Drift perpetual swaps. The strategy edge is in advanced volatility and inventory management models and a superior on-chain infrastructure setup.\n\n **The strategy is built on a smart contract, meaning funds cannot be withdrawn by anyone but you.**",
    cover: "/images/pattern.jpg",
    depositTokens: [
      {
        name: "USDC",
